...
type Arc = 
    ...
    /// <summary>
    /// Возвращает значение, представляющее текущую дугу в матрице инцидентности.
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Возвращает объект дуги, соответствующий указанному значению в матрице инцидентности.
    /// </summary>
    /// <remarks>
    /// Отрицательные значения считаются дугами от позиции к переходу, положительные - от 
    /// перехода к позиции.
    /// </remarks>
    /// <param name="n">Значение в матрице инцидентности.</param>
    /// <returns></returns>
